...
(function() {
  ...
  Vomnibar = {
    ...
    activateWithCompleter: function(completerName, refreshInterval, initialQueryValue, selectFirstResult) {
      var completer;
    ...
    activateWithCurrentUrl: function() {
      return this.activateWithCompleter("omni", 100, window.location.toString());
    },
  ...
  VomnibarUI = (function() {
    ...
    VomnibarUI.prototype.updateSelection = function() {
      ...
      for (i = _i = 0, _ref = this.completionList.children.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        _results.push(this.completionList.children[i].className = (i === this.selection ? "selected" : ""));
      }
      return _results;
    };
    ...
    VomnibarUI.prototype.initDom = function() {
      var _this = this;
      this.box = Utils.createElementFromHtml('<div id="vomnibar" class="vimiumReset">' + '<div class="searchArea">' + '<input type="text" />' + '</div>' + '<ul></ul>' + '</div>');
      this.box.style.display = "none";
