...
(function() {
  ...
  Suggestion = (function() {
    ...
    Suggestion.prototype.generateHtml = function() {
      ...
      return this.html = "<div class='topHalf'>         <span class='source'>" + this.type + "</span>         <span class='title'>" + (this.highlightTerms(Utils.escapeHtml(this.title))) + "</span>       </div>       <div class='bottomHalf'>        <span class='url'>" + (this.shortenUrl(this.highlightTerms(this.url))) + "</span>        " + relevancyHtml + "      </div>";
    };
    ...
    Suggestion.prototype.highlightTerms = function(string) {
      ...
      for (_j = 0, _len1 = ranges.length; _j < _len1; _j++) {
        ...
        string = string.substring(0, start) + "<span class='match'>" + string.substring(start, end) + "</span>" + string.substring(end);
      }
      return string;
    };
